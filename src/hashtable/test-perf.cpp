...
#define DS_CONTAINS(s,k,e,c)  ht_contains(s,k,e,c)
#define DS_ADD(s,k,v,e,c)     ht_add(s, k,(k+4),e,c)
#define DS_REMOVE(s, k, e, c)    ht_remove(s, k, e, c)
#define DS_SIZE(s)          ht_size(s)
#define DS_NEW(e)            ht_new(e)
#define DS_DELETE(s)         
