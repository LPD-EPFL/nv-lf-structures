...
#define DS_CONTAINS(s,k,e,c )  sl_contains(s,k,e)
#define DS_ADD(s,k,v,e,c )     sl_add(s, k,(k+4),e)
#define DS_REMOVE(s, k, e,c )    sl_remove(s, k, e)
#define DS_SIZE(s)          sl_set_size(s)
#define DS_NEW(e)            sl_set_new(e)
#define DS_DELETE(s)
