...
#define DS_CONTAINS(s,k,e,c )  set_contains_l(s,k,e)
#define DS_ADD(s,k,v,e,c )     set_add_l(s, k,(k+4),e)
#define DS_REMOVE(s, k, e,c )    set_remove_l(s, k, e)
#define DS_SIZE(s)          set_size_l(s)
#define DS_NEW(e)            set_new_l(e)
#define DS_DELETE(s)
