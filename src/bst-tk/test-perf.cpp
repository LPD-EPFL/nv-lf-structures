...
#define DS_CONTAINS(s,k,e,c )  set_contains(s,k,e)
#define DS_ADD(s,k,v,e,c )     set_add(s, k,(k+4),e)
#define DS_REMOVE(s, k, e,c )    set_remove(s, k, e)
#define DS_SIZE(s)          set_size(s)
#define DS_NEW(e)            set_new(e)
#define DS_DELETE(s)
